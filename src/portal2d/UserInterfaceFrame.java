...
public class UserInterfaceFrame extends JFrame {
                ...
                case "mouseTools":
                    ...
                    switch(selection) {
                        ...
                        case "Delete Tool":
                            ...
                            break;
                        case "Fire Portal":
                            t = physicsEngine.new FirePortalTool();
                            break;
                        case "Pick Up":
                            t = physicsEngine.new PickUpTool();
                            break;
                    }
    ...
    public UserInterfaceFrame(PhysicsPanel p) {
        ...
        mouseTools = new JComboBox(new String[] {"Force Tool", "Force Drag Tool", "Linear Drag Tool", "Delete Tool", "Rectangle", "N Sided Polygon", "Custom Polygon", "Fire Portal", "Pick Up"});
