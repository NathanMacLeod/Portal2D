...
//        g.drawLine((int) (p1.x - cp.x + cam.getWidth()), (int) (p1.y - cp.y + cam.getHeight()), (int) (p1.x + getNormalUnitVector().multiplyByScalar(10).getXComp() - cp.x + cam.getWidth()), (int) (p1.y + getNormalUnitVector().multiplyByScalar(10).getYComp() - cp.y + cam.getHeight()) );
//    }   
}
